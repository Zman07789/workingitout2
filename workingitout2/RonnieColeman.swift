        ...
        VStack {
            ...
            if isVideoPlaying {
                VideoPlayer(player: player)
                    .aspectRatio(contentMode: .fit) // Added content mode setting
                    .onAppear {
                        setupVideoPlayer()
                        player.play()
                    }
...
struct RonnieColemanView_Previews: PreviewProvider {
